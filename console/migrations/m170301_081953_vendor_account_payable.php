...
class m170301_081953_vendor_account_payable extends Migration
{
    public function up()
    {
        $this->createTable('whitebook_vendor_account_payable', [
        ...
        $this->createIndex ('vendor_account_payable_v_inx', 'whitebook_vendor_account_payable', 'vendor_id');

        $this->addForeignKey ('vendor_account_payable_v_fk', 'whitebook_vendor_account_payable', 'vendor_id', 'whitebook_vendor', 'vendor_id', 'SET NULL' , 'SET NULL');
    }
    ...
    public function down()
    {
        $this->dropForeignKey(
            ...
            'whitebook_vendor_account_payable'
        );
