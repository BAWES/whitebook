...
class VendorDraftItem extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['item_id', 'type_id', 'vendor_id', 'item_amount_in_stock', 'item_default_capacity', 'sort', 'item_how_long_to_make', 'item_minimum_quantity_to_order', 'created_by', 'modified_by'], 'integer'],
