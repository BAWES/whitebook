        ...
        <tbody>
            ...
            <tr>
                <td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="left">
                    ...
                    <b>Name</b> : <?= $model->customer_name. ' ' .$model->customer_last_name ?>

                    <br /><br />

                    <b>Email</b> : <?= $model->customer_email ?>

                    <br /><br />

                    <b>Date of birth</b> : <?= $model->customer_dateofbirth ?>

                    <br /><br />

                    <b>Gender</b> : <?= $model->customer_gender ?>

                    <br /><br />

                    <b>Mobile</b> : <?= $model->customer_mobile ?>
