        ...
        <tbody>
            <tr>
                <td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="left">
                    ...
                    The booking is cancelled now for <?= $items ?> on <?= date('d/m/Y h:i A') ?> because customer have not paid within 24 hour.

                    <br />
                    <br />

                    Vendor : <?= $vendor->vendor_name ?> <br />
                    Order ID : <?= $request->order_id ?> <br />
                    Sub Order ID : <?= $request->suborder_id ?> <br />
