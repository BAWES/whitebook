...
{    
    public function rules()
    {
        return [
            ...
            [['item_default_capacity', 'item_minimum_quantity_to_order', 'minimum_increment', 'type_id', 'hide_price_chart'], 'integer', 'on' => ['ItemPrice']],
    ...
    public function scenarios()
    {
        return [
            ...
            'ItemPrice' => ['item_base_price', 'hide_price_chart', 'minimum_increment', 'quantity_label', 'item_price_description', 'item_price_description_ar','item_default_capacity', 'item_minimum_quantity_to_order', 'item_price_per_unit', 'min_order_amount', 'type_id'],
