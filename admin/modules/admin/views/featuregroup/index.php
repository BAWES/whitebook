    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
             ...
             'format'=>'raw',
			  'value'=>function($data) {
				return HTML::a('<img src='.Yii::$app->newcomponent->statusImageurl($data->group_status).' id="image-'.$data->group_id.'" alt="Status Image" title='.Yii::$app->newcomponent->statusTitle($data->group_status).'>','javascript:void(0)',['id'=>'status', 
...
<script type="text/javascript">
	...
	{		
        ...
        var path = "<?php echo Url::to(['/admin/featuregroup/block']); ?> ";
        $.ajax({  
        type: 'POST',      
