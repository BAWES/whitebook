...
$(function (){
    $("#priorityitem-category_id").change(function (){
        ...
        var path = "<?php echo Url::to(['/priority-item/loadsubcategory']); ?> ";
        $('.loadingmessage').show();
        $.ajax({
        type: 'POST',
...
$(function (){
    $("#priorityitem-subcategory_id").change(function (){
        ...
        var path = "<?php echo Url::to(['/priority-item/loadchildcategory']); ?> ";
        $('.loadingmessage').show();
        $.ajax({
        type: 'POST',
        url: path, //url to be called
...
$(function (){
    $("#priorityitem-child_category").change(function (){
        ...
        $('.loadingmessage').show();
        var path = "<?php echo Url::to(['/priority-item/loaditems']); ?> ";
        $.ajax({
        type: 'POST',
        url: path, //url to be called
...
$(function (){
    $("#priorityitem-item_id").on("change",function (){
        ...
        var path = "<?php echo Url::to(['/priority-item/loaddatetime']); ?> ";
...
<?php } ?>
 ...
 $("#submit1").click(function () {
        ...
        var va='';
        var path = "<?php echo Url::to(['/priority-item/checkprioritydate']); ?> ";
