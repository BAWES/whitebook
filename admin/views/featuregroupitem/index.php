...
<p>
    ...
    [
			...
			[
             ...
             'format'=>'raw',                 
			  'value'=>function($data) {
				return HTML::a('<img src='.$data->statusImageurl($data->group_item_status).' id="image-'.$data->featured_id.'" alt="Status Image" title='.Yii::$app->newcomponent->statusTitle($data->group_item_status).'>','javascript:void(0)',['id'=>'status', 
