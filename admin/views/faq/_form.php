...
<div class="faq-form">
    ...
    <div class="form-group">
        <?= $form->field($model, 'question_ar',['template' => "{label}<div class='controls'>{input}</div>{hint}{error}"])->textarea(['rows' => 6,'maxlength' => 128])?>
    </div> 
    ...
    <div class="form-group">
        <?= $form->field($model, 'answer_ar',['template' => "{label}<div class='controls'>{input}</div>{hint}{error}"])->textarea(['rows' => 6,'maxlength' => 128])?>
    </div> 
