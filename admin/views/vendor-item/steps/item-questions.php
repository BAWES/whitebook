...
<div class="tabbable">
    <ul class="nav nav-tabs">
        ...
        <li>
            <a href="<?= Url::to(['vendor-item/item-approval', 'id' => $item_id]) ?>">
                Approval
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="<?= Url::to(['vendor-item/item-videos', 'id' => $item_id]) ?>">
                Videos
            </a>
        </li>
        <li class="active">
        ...
        <li>
            <a href="<?= Url::to(['vendor-item/item-themes-groups', 'id' => $item_id]) ?>">
                Other
            </a>
        </li>
    </ul>
	...
	<div class="tab-content">
		<div class="tab-pane clearfix active">
			...
			<div class="row">				
				<div class="col-md-4">
					<a href="<?= Url::to(['vendor-item/item-images', 'id' => $item_id]) ?>" class="btn btn-info pull-left">Prev</a>
				</div>
