    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
			  ...
			  'format' => 'raw',
			  'value'=>function($data) {
				return HTML::a('<img src='.$data->statusImageurl($data->page_status).' id="image-'.$data->page_id.'" title='.Yii::$app->newcomponent->statusTitle($data->page_status).'>','javascript:void(0)',['id'=>'status', 
