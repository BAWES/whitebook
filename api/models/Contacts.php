...
class Contacts extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['contact_name', 'contact_email','subject', 'message'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('api', 'ID'),
            'contact_name' => Yii::t('api', 'Contact Name'),
            'contact_email' => Yii::t('api', 'Contact Email'),
            'contact_phone' => Yii::t('api', 'Contact Phone'),
            'subject' => Yii::t('api', 'Subject'),
