...
$config = [
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'yzIBktvzm_BR7Rr70U6cZqjRLw1eqDin',
        ],
        'urlManager' => [
          ...
          'rules' => [
                ...
                'product/getdeliverytimeslot' => 'product/getdeliverytimeslot',
                'product/<slug:[A-Za-z0-9\_-]+>' => 'product/product/',

                'buy-product/<slug:[A-Za-z0-9\_-]+>' => 'buy-product/product/',
                // BEGIN define  page name
