...
function resize() 
{
    ...
    {
        $contents  = '<div class="col-lg-3 padding-left-0 theme-filter">' + $('.overlay_filter .date-filter').html() + '</div>';
...
$(document).delegate('.filter_butt', 'click', function(){
    $('#left_side_cate, .overlay_filter').toggleClass('hidden-sm');
    $('#left_side_cate, .overlay_filter').toggleClass('hidden-xs');
...
$(document).delegate('#register', 'click', function()
{
    ...
    {
        $('#gen_er').show();
        $('#gen_er').html(the_field_is_required);
    }
    else
    {
        $('#gen_er').hide();
    ...
    {
        $('#dob_er').show();
        $('#dob_er').text(the_field_is_required);
    }
    else
    {
        $('#dob_er').hide();
    ...
    */
    ...
    else
    {
        if(x != ''){
            l=0;
            $("#customer_email").show();
            $("#customer_email").html(enter_a_valid_email_id);
        }
    }
