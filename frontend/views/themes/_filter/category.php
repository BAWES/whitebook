...
if ($category_slug && $category_slug != 'All') {
	$subcategory = \common\models\SubCategory::loadsubcat($category_slug);
		...
		<div class="panel panel-default" >
			...
			<div id="<?= $value['category_id']; ?>" <?= $t; ?> class="panel-collapse collapse <?= $in; ?>"  >
				<div class="panel-body">
					<div class="table">
						<?php $childcategory = \common\models\ChildCategory::loadchildcategoryslug($value['category_id']);
						...
						<ul class="<?= $class; ?>">
							...
							foreach ($childcategory as $key => $value) {
								...
								<li>
									...
									<input name="items" data-element="input" class="items" id="checkbox-<?= $value['category_name'] ?>" value="<?= $value['slug'] ?>" step="<?= $value['category_id'] ?>" type="checkbox" <?php echo (isset($checked) && $checked !="") ?  $checked : ''; ?> >
