                                    ...
                                    <ul class="padding0">
                                        <li class="day-select">
                                            <select name="bday" id="bday" class="selectpicker" data-style="btn-primary" style="display: none;">
                                                ...
                                                <?php for ($i = 1; $i <= 31; $i++) {
                                                    ?>
                                                    <option value="<?php echo $i; ?>" <?php if (isset($model['bday']) && $model['bday'] == $i) {
...
function default_session_data(x)
{
    ...
    if ((!empty($reset_password))) {
        ...
        window.onload = display_reset_password_modal;</script>
        <?php } ?>
        <script type="text/javascript">
        /* BEGIN ADD EVENT */
        ...
        if ($event_status > 0) {
            ...
            <script type="text/javascript">
            var x = '<?= $event_status; ?>';
            window.onload = addevent1(x);</script>
        ...
        if (Yii::$app->session->get('key') == 1) {
            ?>
            <script type="text/javascript">
            window.onload = show_activate_modal_true();</script>
        ...
        if (Yii::$app->session->get('key') == 2) {
            ...
            window.onload = show_password_reset_modal_true();</script>
            <?php Yii::$app->session->set('key', '0');
        } ?>
