...
<html lang="<?= Yii::$app->language ?>">
	...
	<body class="has-js">
		...
		$this->beginContent('@app/views/layouts/theme1/header.php');   ?>
		<?php  		 $this->endContent(); ?>
		<!-- Header Section End -->
		...
		<?php $this->beginContent('@app/views/layouts/theme1/footer.php',['socialinfo'=>Socialinfo::socialinformation(), 'siteinfo'=>Siteinfo::siteinformation()]); ?>
		<?php $this->endContent(); ?>
		<!-- Footer Section End -->
	</body>
</html>
