                ...
                <div class="tab_sections"> 
                    <div id="exTab2"> 
                        <ul class="nav nav-tabs">
                            <li class="col-md-6 col-xs-6 padding0 first-event-tab <?php if ($c_url1[0] == 'events') {
    echo 'active';
} ?>">
                                <a data-toggle="tab" href="#1" aria-expanded="false">EVENTS</a>
                            </li>
                            <li class="col-md-6 col-xs-6 padding0 second-event-tab <?php if ($c_url1[0] == 'thingsilike') {
    echo 'active';
                        ...
                        <!-- <div id="loader1" style="display:none;text-align:center;margin-bottom: 10px;"><img src="<?php echo Yii::$app->params['IMAGE_PATH']; ?>ajax-loader.gif" title="Loader"></div> -->
                            <div id="1" class="tab-pane <?php if ($c_url1[0] == 'events') {
    echo 'active';
} ?>">
...
<?php foreach ($customer_event_type as $key => $value) { ?>
                                            ...
                                            <li>
                                                ...
                                                <a href="<?php echo Yii::$app->params['BASE_URL'] . '/event-details/' . $value['slug']; ?>" id="<?php echo $value['event_id']; ?>" title="<?= $value['event_name']; ?>">
                                                    ...
                                                    <div class="thing_inner_items">
                                                        <h3><?php if (strlen($value['event_name']) > 12) {
...
<?php } ?>                                                     
                                        <li>
                                            <div class="thing_inner_items border_none <?php if ($c_url1[0] == 'thingsilike') {
    echo 'active';
} ?>">
                            ...
                            <div id="2" class="tab-pane second_event <?php if ($c_url1[0] == 'thingsilike') {
    echo 'active';
} ?>">
