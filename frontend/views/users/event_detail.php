                                                ...
                                                <div class="panel-body">
                                                    <div class="events_inner_listing_new">
                                                        <div class="events_listing">
                                                            <ul>
                                                                <?php
                                                                //$cat_exist1[] = array_push($cat_exist,$load_cat['category_id']);
    ...
    <?php } ?>
                                                            <div class="events_brows_buttons_common">
                                                                <div class="margin_0_auto">
                                                                    <a href="<?php echo Yii::$app->params['BASE_URL']; ?>/products/<?php echo $value1['slug']; ?>" class="btn btn-danger">BROWSE THE CATEGORY</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
