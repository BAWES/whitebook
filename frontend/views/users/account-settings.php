                    ...
                    <div class="accont_info">
                        ...
                        <div class="account_form">
                            <div class="bs-example" data-example-id="basic-forms">
                                <form method="POST" action="<?php echo Yii::$app->params['BASE_URL']; ?>/edit-profile" name="account_setting" id="account_setting" name="account_setting">
                                    ...
                                    <?php
                                    $dob = $user_detail[0]['customer_dateofbirth'];
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 col-xs-3 paddingleft0"><div class="select_boxes">                                   
                                                    <select name="bday_detail" id="bday_detail" class="selectpicker" data-style="btn-primary" style="display: none;">
                                                        ...
                                                        <?php for ($i = 1; $i <= 31; $i++) {
                                                            ?>
                                                            <option value="<?php echo $i; ?>" <?php if (isset($day) && $day == $i) {
...
?>
                                            ...
                                            <div class="col-md-4 col-xs-4 paddingcommon"><div class="select_boxes">                                   
                                                    <select class="selectpicker" data-style="btn-primary" style="display: none;" id="bmonth_detail" name="bmonth_detail">
                                                        ...
                                                        <option value="1" <?php if (isset($month) && $month == 1) {
    echo "selected=selected";
} ?>>Jan</option>
                                                        <option value="2" <?php if (isset($month) && $month == 2) {
    echo "selected=selected";
} ?>>Feb</option>
                                                        <option value="3" <?php if (isset($month) && $month == 3) {
    echo "selected=selected";
} ?>>Mar</option>
                                                        <option value="4" <?php if (isset($month) && $month == 4) {
    echo "selected=selected";
} ?>>Apr</option>
                                                        <option value="5" <?php if (isset($month) && $month == 5) {
    echo "selected=selected";
} ?>>May</option>
                                                        <option value="6" <?php if (isset($month) && $month == 6) {
                                                            echo "selected=selected";
                                                        } ?>>Jun</option>
                                                        <option value="7" <?php if (isset($month) && $month == 7) {
                                                            echo "selected=selected";
                                                        } ?>>Jul</option>
                                                        <option value="8" <?php if (isset($month) && $month == 8) {
                                                            echo "selected=selected";
                                                        } ?>>Aug</option>
                                                        <option value="9" <?php if (isset($month) && $month == 9) {
                                                            echo "selected=selected";
                                                        } ?>>Sep</option>
                                                        <option value="10" <?php if (isset($month) && $month == 10) {
                                                            echo "selected=selected";
                                                        } ?>>Oct</option>
                                                        <option value="11" <?php if (isset($month) && $month == 11) {
                                                            echo "selected=selected";
                                                        } ?>>Nov</option>
                                                        <option value="12" <?php if (isset($month) && $month == 12) {
                                                            echo "selected=selected";
                                                        } ?>>Dec</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="select_boxes">                                   
                                                <select class="selectpicker" data-style="btn-primary" style="display: none;" id="gender_detail" name="gender_detail">
                                                    ...
                                                    <option value="Male" <?php if (isset($user_detail[0]['customer_gender']) && $user_detail[0]['customer_gender'] == 'Male') {
    echo "selected=selected";
} ?>>Male</option>
                                                    <option value="Female" <?php if (isset($user_detail[0]['customer_gender']) && $user_detail[0]['customer_gender'] == 'Female') {
    echo "selected=selected";
} ?>>Female</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-6 paddingleft0">
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="customer_password" name="customer_password" class="form-control required" placeholder="<?php echo Yii::t('frontend', 'enter_your_password'); ?>" title="<?php echo Yii::t('frontend', 'enter_your_password'); ?>" value="<?php echo $user_detail[0]['customer_org_password']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 paddingright0">
                                        <div class="form-group">
                                        ...
                                        <div data-example-id="basic-forms" class="bs-example">
                                            ...
                                            <div class="col-md-6 paddingleft0">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Enter your Judda name" id="judda" name="judda" class="form-control required" value="<?php echo $user_detail[0]['juda']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6 paddingright0">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Phone Number</label>
                                                    <input type="text" placeholder="Example +965 56 555 5555" id="phone_detail1" name="phone_detail1" class="form-control required" value="<?php echo $user_detail[0]['phone']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12 padding0">
                                                <div class="form-group text_aeriya">
                                                    <label for="exampleInputPassword1">Extra Details</label>
                                                    <textarea placeholder="if you have extra details write it here" id="extra" name="extra" rows="3" class="form-control required"><?php echo $user_detail[0]['extra']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
...
foreach ($loadcity as $key => $val) {
    ...
    if (isset($city_count) && $city_count == $key) {
        $selected = 'selected';
    } else {
        $selected = '';
    }
...
<script type="text/javascript">
    $('#saved').on('click', function () {
        ...
        if (jQuery('#account_setting').valid() && i == 1 && j == 1 && l == 1 && m == 1)
        {
            ...
            jQuery.ajax({
                url: "<?php echo Yii::$app->params['BASE_URL']; ?>/edit-profile",
                type: "post",
