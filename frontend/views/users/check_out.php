...
<?php foreach($addresstype as $key=>$val)
{
...
window.setTimeout(function(){window.location.replace("<?php echo Yii::$app->params['BASE_URL'].'/basket';?>")},2000)
}
}
});
...
success: function( data ) {alert(989);
alert(data);
