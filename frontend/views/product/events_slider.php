...
if (Yii::$app->params['CUSTOMER_ID'] != '') {
    ...
    <?php if (count($customer_events) == 0) { ?>
        <div class="container_eventslider">
            <span class="first_events"><img src="<?php echo Yii::$app->params['BASE_URL']; ?>/frontend/web/images/my_book_desk.svg" alt="My White Book"/></span>
    ...
    <?php } else { ?>
        <div class="directory_slider" id="oner">
            <div class="event_slider_top">
                <div class="col-md-3">
                    <img class="top_whit" src="<?php echo Yii::$app->params['BASE_URL']; ?>/frontend/web/images/my_book_desk.svg" alt="My White Book"/>
                </div>
                <div class="col-md-8">
                            ...
                            <div id="owl-demo" class="owl-carousel">
                                <div class="item" style=" background: transparent;">
                                    <?php if (!empty($customer_events)) { ?>
                                        <a href="<?php echo Yii::$app->params['BASE_URL']; ?>/thingsilike" class="thing_cont" title="Things I like"><span class="heart_fave" id="heart_fave"><?= count($wishlist); ?></span>
                                            Things I like</a>
                                    <?php } else { ?>
        ...
        <?php foreach ($customer_events as $key => $value) { ?>
                                    <a href="<?php echo Yii::$app->params['BASE_URL'] . '/event-details/' . $value['slug']; ?>">
                                        <div class="item">
                                            <h4><?php if (strlen($value['event_name']) > 12) {
                echo substr($value['event_name'], 0, 12) . ' ...';
            } else {
