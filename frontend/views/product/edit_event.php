...
<h4 class="modal-title text-center" id="myModalLabel"><?php echo Yii::t('frontend','EDIT_EVENT');?></h4>
</div>
...
<input type="text" name="event_name" class="form-control required" id="edit_event_name" value="<?php echo $edit_eventinfo[0]['event_name']; ?>" placeholder="<?php echo Yii::t('frontend','enter_event_name');?>" title="<?php echo Yii::t('frontend','enter_event_name');?>">
</div>
<div class="form-group">
...
<input readonly="true" name="event_date" id="edit_event_date" class="form-control required datetimepicker" value=<?= date('d-m-Y',strtotime($edit_eventinfo[0]['event_date'])); ?> placeholder="<?php echo Yii::t('frontend','choose_event_date');?>" title="<?php echo Yii::t('frontend','choose_event_date');?>">
...
<option value="<?php echo $e['type_name']; ?>" <?php if($edit_eventinfo[0]['event_type'] == $e['type_name']) { echo "selected=selected"; }else { echo '';}?>><?php echo $e['type_name'];?></option>
<?php } ?>
</select>
