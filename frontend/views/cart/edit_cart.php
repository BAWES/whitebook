...
<form class="form col-md-12 center-block" id="loginForm" name="update-cart" method="POST">
	...
	<div class="col-md-12 padding-left-0">
		<div class="form-group">
			...
			<div data-date-format="dd-mm-yyyy" data-date="12-02-2012" class="input-append date position-relative" id="delivery_date_wrapper">
				<input value="<?=$deliver_date?>" readonly="true" name="delivery_date" id="delivery_date3" class="date-picker-box form-control required"  placeholder="<?php echo Yii::t('frontend', 'Date'); ?>" >
	...
	<div class="col-md-12 padding-left-0">
		<input type="submit" name="change" value="Change" class="btn btn-primary pull-right btn-checkout">
	</div>
</form>