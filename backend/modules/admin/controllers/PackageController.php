...
class PackageController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
			...
			Yii::$app->newcomponent->activity('Admin', 'created new '.$model->package_name.' package');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
			...
			Yii::$app->newcomponent->activity('Admin', 'updated  this '.$model->package_name.' package information');
            return $this->redirect(['index']);
        } else {
        ...
        public function actionPackageupdate()
    {
		...
		echo json_encode(array("id"=>$id,"start"=>$start,"end"=>$end,)); exit;
		}
    }
