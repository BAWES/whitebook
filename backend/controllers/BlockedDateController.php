   ...
   /**
    ...
    public function actionCreate()
    {
        ...
        if($model->load(Yii::$app->request->post()) && $model->validate())
        {
            ...
            Yii::$app->session->setFlash('success', "Blocked date created successfully!");
    ...
    public function actionCreateweek()
    {
        ...
        if($model->load(Yii::$app->request->post()))
        {
            ...
            Yii::$app->session->setFlash('success', "Blocked weekday created successfully!");
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            Yii::$app->session->setFlash('success', "Blocked date updated successfully!");
    ...
    public function actionDelete($id)
    {
		...
		Yii::$app->session->setFlash('success', "Blocked date deleted successfully!");
        return $this->redirect(['index']);
    }
