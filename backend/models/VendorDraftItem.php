...
class VendorDraftItem extends \common\models\VendorDraftItem
{
    public function rules()
    {
        return [
            ...
            [['item_default_capacity', 'item_minimum_quantity_to_order', 'hide_price_chart'], 'integer', 'on' => ['ItemPrice']],
    ...
    public function scenarios()
    {
        ...
        $scenarios['ItemPrice'] = ['type_id', 'hide_price_chart', 'minimum_increment', 'min_order_amount', 'quantity_label', 'item_default_capacity', 'item_minimum_quantity_to_order', 'item_price_per_unit', 'item_base_price', 'item_price_description', 'item_price_description_ar', 'item_customization_description', 'item_customization_description_ar'];
