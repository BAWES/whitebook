...
<div class="form-group">    
	<?= $form->field($model, 'priority_level',[
		'template' => "{label}<div class='controls'>{input}</div>
		{hint}
		{error}"])->dropDownList([ 'normal' => 'Normal', 'super' => 'Super', ], ['prompt' => '']) ?>
</div>
...
<div class="form-group">    
	<?= $form->field($model, 'modified_datetime',[
		'template' => "{label}<div class='controls'>{input}</div>
		{hint}
		{error}"])->textInput() ?>
</div>
...
<div class="form-group">    
	<?= $form->field($model, 'trash',[
		'template' => "{label}<div class='controls'>{input}</div>
		{hint}
		{error}"])->dropDownList([ 'default' => 'Default', 'deleted' => 'Deleted', '' => '', ], ['prompt' => '']) ?>
</div>	
