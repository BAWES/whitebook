	...
	<div class="tabbable">
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="3">
				...
				<!-- guide image -->
				<div class="form-group guide_image"><?= $form->field($model, 'guide_image[]',['template' => "{label}<div class='controls append_address'>{input}</div> {hint} {error}"])->fileInput(['multiple' => true]) ?></div>
...
echo Html::hiddenInput('imagedata',$imagedata,['id'=>'imagedata']);
echo Html::hiddenInput('img',$img,['id'=>'img']);
echo Html::hiddenInput('action',$act,['id'=>'action']);
echo Html::hiddenInput('guideimagedata',$guideimagedata,['id'=>'guideimagedata']);
echo Html::hiddenInput('img1',$img1,['id'=>'img1']);
echo Html::hiddenInput('action1',$img1,['id'=>'action1']);
