 <?php use yii\helpers\Html; ?>
	...
	<div class="page-sidebar" id="main-menu"> 
		...
		<ul>
			...
			<li class="<?php if ($menu_act == 'ActivitylogController') {echo "active"; } else  {echo "noactive";}?>">
				<?= Html::a('<i class="fa fa-book"></i><span class="title">Activity Log</span>', ['activitylog/index'], ['class'=>'link-title']) ?>
			</li>				
		</ul>
